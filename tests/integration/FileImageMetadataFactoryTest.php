...
class FileImageMetadataFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $imageMetadata = $this->factory->create(__DIR__ . '/fixture/image.jpg');
    ...
    {
        $imageMetadata = $this->factory->create(__DIR__ . '/fixture/image_or2.jpg');
    ...
    {
        $imageMetadata = $this->factory->create(__DIR__ . '/fixture/image_or3.jpg');
    ...
    {
        $imageMetadata = $this->factory->create(__DIR__ . '/fixture/image_or4.jpg');
    ...
    {
        $imageMetadata = $this->factory->create(__DIR__ . '/fixture/image_or5.jpg');
    ...
    {
        $imageMetadata = $this->factory->create(__DIR__ . '/fixture/image_or6.jpg');
    ...
    {
        $imageMetadata = $this->factory->create(__DIR__ . '/fixture/image_or7.jpg');
    ...
    {
        $imageMetadata = $this->factory->create(__DIR__ . '/fixture/image_or8.jpg');
    ...
    {
        $imageMetadata = $this->factory->create(__DIR__ . '/fixture/image.png');
